...
function boilerplate_load_assets()
{
  ...
  wp_enqueue_style('ely-style-css', get_theme_file_uri('/assets/styles/style.css'), array(), '2.02', );
  ...
  wp_enqueue_script('ely-script-js', get_theme_file_uri('/assets/js/script.js'), array(), '1.6', true);
